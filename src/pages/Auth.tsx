...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-8 safe-top">
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold font-display">TripTracker</h1>
        ...
        <form onSubmit={handleSubmit} className="glass-card p-5 space-y-3">
          ...
          <Button type="submit" className="btn-primary w-full h-12 text-base mt-2" disabled={loading}>
            {loading ? (
